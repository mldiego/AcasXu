...
%COMBINEDDUB Combined dynamics of 2 Dubins airplanes
    ...
    % dx(8,1) = ((x(4)-x(1))*(x(4)-x(1)+sqrt(((x(4)-x(1))^2)+(x(5)-x(2))^2)*dx(5,1)))/(sqrt((x(4)-x(1))^2+(x(5)-x(2))^2)*((x(4)-x(1))^2+(x(5)-x(2))^2+ x(4)*sqrt(x(5)^2+x(4)^2-2*x(4)*x(1)+x(1)^2+x(2)^2-2*x(5)*x(2))-x(1)*sqrt(x(5)^2+x(4)^2-2*x(4)*x(1)+x(1)^2+x(2)^2-2*x(5)*x(2)))+eps)    -     (2*(1+(x(4)-x(1))/(sqrt((x(4)-x(1))^2+(x(5)-x(2))^2)))*(x(5)-x(2))*dx(4,1))/(eps+((x(4)-x(1)+sqrt((x(4)-x(1))^2+(x(5)-x(2))^2))^2*(1+(x(5)-x(2)^2)/(x(4)-x(1)+sqrt((x(4)-x(1))^2+(x(5)-x(2))^2))^2)))    -   (2*(-1-(x(4)-x(1))/(sqrt((x(4)-x(1))^2+(x(5)-x(2))^2)))*(x(5)-x(2))*dx(1,1))/(eps+((x(4)-x(1)+sqrt((x(4)-x(1))^2+(x(5)-x(2))^2))^2*(1+(x(5)-x(2)^2)/(x(4)-x(1)+sqrt((x(4)-x(1))^2+(x(5)-x(2))^2))^2)))    -    ((x(4)-x(1))*(x(4)-x(1)+sqrt(((x(4)-x(1))^2)+(x(5)-x(2))^2)*dx(2,1)))/(sqrt((x(4)-x(1))^2+(x(5)-x(2))^2)*((x(4)-x(1))^2+(x(5)-x(2))^2+ x(4)*sqrt(x(5)^2+x(4)^2-2*x(4)*x(1)+x(1)^2+x(2)^2-2*x(5)*x(2))-x(1)*sqrt(x(5)^2+x(4)^2-2*x(4)*x(1)+x(1)^2+x(2)^2-2*x(5)*x(2)))+eps) - dx(3,1)  ; % theta
    % Including state variavle 7 (distance)
