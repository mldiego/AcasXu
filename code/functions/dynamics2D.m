...
%Combined dynamics of 2 Dubins airplanes
    ...
    dx(8,1) = 2/((x(4)-x(1)+x(7))*(1+(x(5)-x(2))^2/(x(4)-x(1)+x(7))^2))*((dx(5,1)-dx(2,1))+((x(5)-x(2))*(dx(1,1)-dx(4,1)-dx(7,1))/(x(4)-x(1)+x(7)))); % theta (rad)
%     dx(8,1) =  (2*(dx(5,1)-dx(2,1))*(x(4)-x(1)+x(7)) + (2*(x(5)-x(2))*(dx(1,1)-dx(4,1)-dx(7,1))))/((x(4)-x(1)+x(7))^2*(1+(x(5)-x(2)^2)/(x(4)-x(1)+x(7))^2)) - dx(3,1); % theta (rad)
