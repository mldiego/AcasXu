...
sim_data = load('../data_sim/SimRandom_all.mat');
...
yl = [[33500 79900];[9000 33000];[19200 34070];[0 14300];[118750 136300];
    [9000 43000];[47000 96000];[23200 43700];[13000 37500];[28600 48500]];
set(groot,'defaultFigureVisible','on')
f = figure;
hold on;
grid;
% for k=3:length(data_files)
%     output = load(string(data_files(k).folder)+ "/" + string(data_files(k).name)); % variables: output
...
ax.XAxis.FontSize = 15; % Set font size of axis
ax.YAxis.FontSize = 15;
% saveas(f,"../data_reach/figs/TestPoint"+string(tc)+"sim.png");
for k=1:N
